            ...
            <div class="row main">
              ...
              <div class="col-8">
                ...
                <div class="row mt-4 justify-content-center">
                  ...
                  <input class="form-control" v-model="service.name" type="text" id="services" placeholder="E.g. WiFi" @keyup.enter="addService">
                  <div class="row justify-content-center">
...
export default {
  ...
  methods: {
    submit() {
      ...
      axios.post("/RentalObjects/addSpecialOfferVacationRental", {rentalId: this.$route.params.id, initDate: this.initDate, termDate: this.termDate, capacity: this.capacity, discount: this.discount, includedServices: this.services}, {
        headers: {
