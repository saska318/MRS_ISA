...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      axios.post("/RentalObjects/addSpecialOfferBoat", {rentalId: this.$route.params.id, initDate: this.initDate, termDate: this.termDate, discount: this.discount, capacity: this.capacity, includedServices: this.includedServices},
          {
            headers: {
